...
extension FeatureStrings {
    static func notchEditor(_ language: AppLanguage) -> NotchEditorStrings {
        ...
        case .sk: return NotchEditorStrings(
            ...
            activity: "Aktivita",
            behavior: "Správanie",
            layoutHint: "Kliknutím na + pridáte tlačidlo. Tlačidlá presúvajte okolo výrezu. Kliknutím na tlačidlo ho upravíte.",
            ...
            activationTimeHint: "Podržte ukazovateľ nad výrezom po túto dobu, aby sa otvoril.",
            activationTimeFormat: "%.2f s",
            ...
            notificationsSummary: "Upozornenia vášho Macu, zhromaždené v Dynamic Island.",

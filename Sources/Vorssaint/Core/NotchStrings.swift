...
extension NotchStrings {
    ...
    static let sk = NotchStrings(
        ...
        hover: "Otvoriť, keď ukazovateľ zostane na Dynamic Island",
        ...
        hoverExpand: "Pri prejdení ukazovateľom úplne rozbaliť",
        shelfWindow: "Otvoriť poličku súborov v Dynamic Island",

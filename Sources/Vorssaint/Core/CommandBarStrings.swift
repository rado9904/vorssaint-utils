...
extension CommandBarFeatureStrings {
    ...
    static let sk = CommandBarFeatureStrings(
        ...
        keepAwakeForFormat: "Nedovoliť uspanie na %@",
        needsSetupFormat: "Zapnite %@ v Nastaveniach",
        ...
        selectionShelf: "Nechať na poličke",
        ...
        sourceMacSettings: "Panely Nastavení systému",
        sourceFiles: "Súbory",

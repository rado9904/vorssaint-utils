...
extension FeatureHubStrings {
    ...
    static let sk = FeatureHubStrings(
        ...
        unusedBanner: "Toto povolenie ste udelili, no žiadna zapnutá funkcia ho nepotrebuje. Ak chcete, odvolajte ho v Nastaveniach systému.",
        ...
        permAutomationTerminal: "Automatizácia Terminalu",
        ...
        explainAutomationTerminal: "Umožňuje otvárať príkazy Homebrew v aplikácii Terminal.",
        ...
        energyPointer: "Sleduje vstup ukazovateľa",

...
extension BrightnessFeatureStrings {
    ...
    static let sk = BrightnessFeatureStrings(
        ...
        keysToggle: "Klávesy jasu sledujú ukazovateľ",
        keysCaption: "Klávesy jasu na klávesnici menia displej pod ukazovateľom.",
        ...
        displayBrightnessShortcutCaption: "Skratky upravujú hlavný displej, alebo displej pod ukazovateľom, ak je zapnuté sledovanie ukazovateľa.",

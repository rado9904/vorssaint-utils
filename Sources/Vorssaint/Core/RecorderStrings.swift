...
extension RecorderFeatureStrings {
    ...
    static let sk = RecorderFeatureStrings(
        ...
        pointerSectionLabel: "Ukazovateľ",
        pointerShowToggle: "Zobrazovať ukazovateľ",
        ...
        noPointerNote: "Táto nahrávka nemá stopu ukazovateľa, takže nie je čo vyhladzovať. Ručne umiestnené priblíženia stále fungujú.",
        ...
        zoomFollowsPointer: "Sleduje ukazovateľ",
